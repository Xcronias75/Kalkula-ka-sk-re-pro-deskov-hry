...
namespace App1
{
    ...
    public partial class Page2_3 : ContentPage
    {
        public Page2_3()
        {
            InitializeComponent();
        ...
        {
            if (!string.IsNullOrWhiteSpace(nameEntry1.Text) && !string.IsNullOrWhiteSpace(nameEntry2.Text) && !string.IsNullOrWhiteSpace(nameEntry3.Text) && !string.IsNullOrWhiteSpace(nameEntry4.Text) && !string.IsNullOrWhiteSpace(nameEntry5.Text))
            {
                ...
                App.Current.MainPage = new NavigationPage(new Page3_3());
            }
            else
            {
