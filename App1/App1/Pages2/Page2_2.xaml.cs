...
namespace App1
{
    ...
    public partial class Page2_2 : ContentPage
    {
        public Page2_2()
        {
            InitializeComponent();
        ...
        {
            if (!string.IsNullOrWhiteSpace(nameEntry1.Text) && !string.IsNullOrWhiteSpace(nameEntry2.Text) && !string.IsNullOrWhiteSpace(nameEntry3.Text) && !string.IsNullOrWhiteSpace(nameEntry4.Text))
            {
                ...
                App.Current.MainPage = new NavigationPage(new Page3_2());
            }
            else
            {
